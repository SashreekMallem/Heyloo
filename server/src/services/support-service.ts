 ...
 */
export async function listSupportRequests(restaurantId: string, status?: SupportStatus) {
  let query = supabase
    .from('support_requests')
    .select('*')
 ...
 */
export async function addSupportRequestNote(
  requestId: string,
  createdBy: string,
  note: string,
 ...
 */
export async function getSupportRequestWithNotes(requestId: string, restaurantId: string) {
