...
export async function generateApiToken(restaurantId, expiresInDays) {
...
export async function listApiTokens(restaurantId) {
    const { data, error } = await supabase
        .from('api_tokens')
        .select('*')
...
export async function revokeApiToken(restaurantId, tokenId) {
