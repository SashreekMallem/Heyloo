...
const PROSE_CLASSES =
  "space-y-4 text-body leading-7 text-foreground [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4 [&_h2]:pt-4 [&_h2]:font-display [&_h2]:text-h3 [&_h2]:font-semibold [&_h3]:pt-2 [&_h3]:text-h4 [&_h3]:font-semibold [&_li]:ml-5 [&_ol]:list-decimal [&_ol]:space-y-1.5 [&_ul]:list-disc [&_ul]:space-y-1.5";
