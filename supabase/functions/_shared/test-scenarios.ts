...
const VET_SCENARIOS: TestScenario[] = [
  ...
  },
  {
    ...
    personaPrompt:
      "You are extremely worried — your dog just got hit by a car a few minutes ago and is " +
      "having trouble breathing. Say this clearly as soon as the agent asks what's going on. Do " +
      "NOT let the conversation turn into routine scheduling — you need to know right now " +
      "whether to rush to an emergency vet or if this clinic can see you immediately. If the " +
      "agent offers to connect you directly to the clinic, accept; otherwise let them take a " +
      "message with your name (Morgan Ellis) and callback number (555-201-0155).",
  },
  {
