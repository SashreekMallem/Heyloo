...
export function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      {/* Ultra-Premium 3D Background Scene */}
      <div className="fixed inset-0 -z-10" ref={sceneRef}>
      ...
      <nav 
        className="relative z-50 backdrop-blur-2xl bg-black/30 border-b border-white/10"
        style={{
          ...get3DTransform(0.3),
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div 
                ...
                style={get3DTransform(1.2)}
              >
                {/* Multi-layer 3D logo construction */}
                <div className="relative w-14 h-14 transform-gpu">
                  ...
                  {/* Main logo surface */}
                  <div className="relative w-full h-full bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 rounded-2xl flex items-center justify-center overflow-hidden">
                    <Headphones 
                    ...
                    <div 
                      className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-black/20 rounded-2xl pointer-events-none"
                      style={{
                    ...
                    <div 
                      className="absolute inset-2 border border-white/20 rounded-xl opacity-30"
                      style={{
                  ...
                  {/* Live status with 3D depth */}
                  <div 
                    className="absolute -top-2 -right-2 w-5 h-5 rounded-full border-3 border-black overflow-hidden"
                    style={{
                  ...
                  >
                    <div className="absolute inset-1 bg-white rounded-full opacity-50 animate-pulse" />
                  </div>
                </div>
              </div>
              ...
              <div>
                <span 
                  className="text-3xl font-black bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent"
                  style={{
                ...
                <div className="text-xs text-gray-400 font-mono tracking-[0.15em] uppercase">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link 
                ...
                style={get3DTransform(0.4)}
              >
                Support
                <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-500 group-hover:w-full transition-all duration-500" />
              </Link>
              
              <Link
                to="/login"
                className="text-sm px-8 py-3 rounded-xl border border-white/20 text-gray-300 hover:text-white hover:bg-white/10 hover:border-white/40 transition-all duration-300 font-medium backdrop-blur-xl relative overflow-hidden"
                style={get3DTransform(0.5)}
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 translate-y-full group-hover:translate-y-0 transition-transform duration-500" />
                <span className="relative">Sign In</span>
              </Link>
              
              <Link
                to="/onboarding"
                className="group relative text-sm px-10 py-4 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white font-bold hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 transition-all duration-500 flex items-center gap-3 shadow-2xl overflow-hidden"
                style={{
                  ...get3DTransform(0.8),
                  boxShadow: `
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-45deg from-cyan-500/10 to-pink-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      {/* Revolutionary Hero with Interactive 3D Device */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-12 max-w-3xl">
              ...
              <div 
                className="inline-flex items-center gap-4 px-8 py-4 rounded-2xl bg-gradient-to-r from-white/10 via-white/15 to-white/10 border border-white/20 backdrop-blur-2xl hover:bg-white/20 transition-all duration-700 cursor-pointer group overflow-hidden"
                style={get3DTransform(0.6)}
              >
                ...
                <span className="text-sm font-mono text-green-400 tracking-wider uppercase relative z-10">Neural AI Online</span>
                <div className="w-px h-6 bg-white/30" />
                <Sparkles className="h-5 w-5 text-blue-400" />
                <span className="text-sm font-semibold text-white relative z-10">Processing Restaurant Orders</span>
              ...
              <div className="space-y-10">
                <h1 
                  className="text-7xl md:text-8xl lg:text-9xl font-black leading-[0.75] tracking-tighter"
                  style={{
                    textShadow: '0 0 100px rgba(59, 130, 246, 0.3)'
                  }}
                >
                  {['Never', 'Miss', 'Another'].map((word, index) => (
                    <span 
                      key={word}
                  ...
                  <span 
                    className="block bg-gradient-to-r from-blue-400 via-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent relative transition-all duration-1000"
                    style={{ 
                      transform: `
                        perspective(1000px)
                  ...
                  >
                    Order
                    <div 
                      className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 h-3 rounded-full"
                      style={{ 
                        width: '400px',
                ...
                <p 
                  className="text-2xl md:text-3xl text-gray-300 leading-relaxed font-light max-w-3xl"
                  style={{
                    transform: `
                ...
                >
                  Revolutionary AI that transforms every customer interaction into profit. 
                  <span className="font-semibold text-white bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                    Smart. Instant. Unstoppable.
                  </span>
                </p>
              </div>

              {/* Premium CTAs */}
              <div className="flex flex-col sm:flex-row items-start gap-8 pt-12">
                <Link
                  to="/onboarding"
                  className="group relative px-16 py-6 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 via-purple-600 to-pink-600 text-white font-bold text-xl transition-all duration-700 flex items-center gap-4 shadow-2xl min-w-[350px] overflow-hidden"
                  style={{ 
                    ...get3DTransform(1.0),
                    boxShadow: `
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/30 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-45deg from-cyan-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 animate-pulse" />
                  
                  <PhoneCall className="h-7 w-7 relative z-10" />
                  <span className="relative z-10">Start Neural Trial</span>
                ...
                <Link
                  to="/support"
                  className="group px-16 py-6 rounded-2xl border-2 border-white/30 text-white font-bold text-xl hover:bg-white/10 hover:border-white/50 transition-all duration-700 flex items-center gap-4 backdrop-blur-2xl min-w-[350px] relative overflow-hidden"
                  style={get3DTransform(0.6)}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/5 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-500" />
                  
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500/30 to-purple-500/30 flex items-center justify-center backdrop-blur-sm relative">
            ...
            {/* Revolutionary Interactive 3D Device Showcase */}
            <div className="relative lg:block hidden">
              <div 
                className="relative w-full h-[600px] mx-auto perspective-2000"
                style={{ 
                ...
                ref={deviceRef}
              >
                {/* Main Interactive Device */}
                <div 
                  className="relative w-96 h-full mx-auto transition-all duration-1200 transform-gpu preserve-3d"
                  style={getDeviceMorphTransform()}
                >
                  
                  {/* PHONE STATE */}
                  {deviceState === 'phone' && (
                    <div className="absolute inset-0 rounded-[3rem] bg-gradient-to-br from-slate-800 via-slate-900 to-black border-2 border-white/20 shadow-2xl overflow-hidden transform-gpu">
                      
                      {/* Screen Bezel */}
                      <div className="absolute inset-6 rounded-[2.5rem] bg-black overflow-hidden">
                        <div className="w-full h-full bg-gradient-to-br from-slate-900 via-black to-indigo-900 relative">
                          ...
                          <div className="flex items-center justify-between p-4 text-white text-sm">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="relative">
                                ...
                                <div className="absolute inset-0.5 bg-green-400 rounded-sm w-3/4" />
                              </div>
                            </div>
                          </div>

                          {/* Premium Incoming Call Interface */}
                          <div className="flex flex-col items-center justify-center h-full -mt-12">
                            
                            {/* Restaurant Caller Avatar with 3D depth */}
                            <div className="relative mb-12">
                              <div 
                                className="w-40 h-40 rounded-full bg-gradient-to-br from-orange-400 via-red-500 to-red-600 flex items-center justify-center relative overflow-hidden"
                                style={{
                                  boxShadow: `
                              ...
                              >
                                <Utensils className="h-20 w-20 text-white relative z-10" />
                                
                                {/* Animated call rings */}
                                <div 
                                  className="absolute inset-0 border-4 border-orange-300/40 rounded-full"
                                  style={{
                                ...
                                />
                                <div 
                                  className="absolute inset-4 border-2 border-red-300/30 rounded-full"
                                  style={{
                            ...
                            <div className="text-center mb-12">
                              <h3 className="text-white text-2xl font-bold mb-3">Tony's Italian Kitchen</h3>
                              <p className="text-blue-300 text-lg mb-2">📞 Incoming Order Call</p>
                              <p className="text-gray-400 text-sm font-mono">+1 (555) 123-PIZZA</p>
                              <div className="flex items-center justify-center gap-2 mt-3 px-4 py-2 rounded-full bg-green-500/20 border border-green-500/30">
                                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                                <span className="text-green-300 text-xs font-semibold">AI Ready</span>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-16 mb-12">
                              <div 
                                className="w-20 h-20 rounded-full bg-red-500 flex items-center justify-center shadow-2xl cursor-pointer hover:scale-110 transition-transform relative overflow-hidden"
                                style={{ 
                                  boxShadow: `
                              ...
                              <div 
                                className="w-24 h-24 rounded-full bg-green-500 flex items-center justify-center shadow-2xl cursor-pointer hover:scale-110 transition-transform relative overflow-hidden"
                                style={{ 
                                  boxShadow: `
                              ...
                              >
                                ...
                                <div 
                                  className="absolute inset-0 bg-green-400/40 rounded-full"
                            ...
                            <div className="flex items-center gap-1">
                              {[...Array(9)].map((_, i) => (
                                <div
                                  key={i}
                                  className="bg-green-400 rounded-full transition-all duration-75"
                                  style={{
                                    width: '3px',
                      ...
                      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-16 h-16 rounded-full border-2 border-white/20 bg-black/40 backdrop-blur-sm" />
                    </div>
                  )}

                  {/* POS TERMINAL STATE */}
                  {deviceState === 'pos' && (
                    <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 border-2 border-white/20 shadow-2xl overflow-hidden">
                      
                      {/* POS Screen */}
                      <div className="absolute inset-8 rounded-2xl bg-black overflow-hidden">
                        <div className="w-full h-full bg-gradient-to-br from-slate-900 via-black to-slate-800 p-6">
                          ...
                          <div className="flex items-center justify-between mb-8 text-white">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-xl font-bold">HEYLOO POS</span>
                            </div>
                          ...
                          <div className="space-y-6">
                            <div className="text-white">
                              <h3 className="text-2xl font-bold mb-4">Order #AI-{Math.floor(Math.random() * 1000)}</h3>
                              <p className="text-blue-300 mb-2">🤖 AI Processing Voice Order...</p>
                            </div>
                            ...
                            <div className="space-y-3">
                              {[
                                ...
                                >
                                  <div>
                                    <span className="text-gray-200 font-medium">{order.item}</span>
                                    {order.status === 'adding...' && (
                                      <div className="text-yellow-400 text-sm mt-1">AI is confirming...</div>
                                    )}
                                  </div>
                                  <div className="text-right">
                                    <span className="text-green-400 font-bold text-lg">{order.price}</span>
                                    {order.status === 'confirmed' && (
                                      <CheckCircle2 className="h-5 w-5 text-green-400 ml-2 inline" />
                                    )}
                                  </div>
                                </div>
                              ))}
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-blue-300">Processing with AI...</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse" />
                                <span className="text-green-400 text-sm font-bold">Payment Ready</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      {/* POS Hardware */}
                      <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-24 h-10 bg-slate-600 rounded-lg shadow-xl">
                        <div className="w-full h-full bg-gradient-to-r from-slate-500 to-slate-700 rounded-lg flex items-center justify-center">
                  ...
                  {deviceState === 'analytics' && (
                    <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-slate-800 via-slate-900 to-black border-2 border-white/20 shadow-2xl overflow-hidden">
                      
                      {/* Dashboard Screen */}
                      <div className="absolute inset-6 rounded-2xl bg-black overflow-hidden">
                        <div className="w-full h-full bg-gradient-to-br from-slate-900 via-black to-indigo-900 p-4">
                          
                          {/* Dashboard Header */}
                          <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-2">
                              <BarChart3 className="h-6 w-6 text-blue-400" />
                              <span className="text-white font-bold text-lg">Revenue Analytics</span>
                            </div>
                            <div className="text-green-400 text-sm font-mono">REAL-TIME</div>
                          </div>
                          ...
                          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                            <div className="text-gray-300 text-sm mb-3">Order Volume (Live)</div>
                            <div className="flex items-end gap-2 h-24">
                              {[...Array(12)].map((_, i) => (
                                <div
                                  key={i}
                                  className="bg-gradient-to-t from-blue-600 to-purple-500 rounded-t-sm flex-1 transition-all duration-300"
                                  style={{
                          ...
                          {/* AI Insights */}
                          <div className="mt-4 p-3 rounded-xl bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30">
                            <div className="flex items-center gap-2 mb-2">
                              <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse" />
                              <span className="text-blue-300 text-xs font-semibold">AI INSIGHT</span>
                            </div>
                            <p className="text-gray-200 text-sm">
                              Peak ordering detected. Recommend activating overflow AI assistant.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                {/* Floating 3D Elements Around Device */}
                {[
                  { 
                    icon: CreditCard, 
                    pos: { top: '15%', right: '15%' }, 
                  ...
                  <div
                    key={i}
                    className={`absolute w-16 h-16 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-2xl transition-all duration-1000`}
                    style={{
                      ...item.pos,
                      transform: `
                        translate3d(
                ...
                <div className="absolute -top-20 left-1/2 transform -translate-x-1/2 flex gap-6">
                  {[
                    ...
                    <div 
                      key={i}
                      className={`px-4 py-3 rounded-2xl backdrop-blur-2xl border transition-all duration-700 cursor-pointer ${
                        item.active 
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        {/* Black premium background with subtle gradients */}
        <div className="absolute inset-0 bg-gradient-to-br from-black via-slate-900 to-black">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.1),transparent)] animate-pulse" />
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20" style={get3DTransform(0.3)}>
            <h2 className="text-6xl md:text-7xl font-black mb-6">
              {['P', 'o', 'w', 'e', 'r', 'e', 'd', ' ', 'b', 'y', ' ', 'A', 'I'].map((char, i) => (
                <span
                  key={i}
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed"
              ...
              Transform your restaurant with cutting-edge AI that understands, processes, and delivers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                {/* 3D Card Container */}
                <div 
                  className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 shadow-2xl overflow-hidden"
                  style={{
                    boxShadow: `
                ...
                >
                  ...
                  {/* Floating Icon */}
                  <div 
                    className={`w-16 h-16 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mb-6 shadow-xl`}
                    style={{
                      transform: `
                        translateZ(30px) 
                ...
                {Array.from({ length: 8 }).map((_, j) => (
                  <div
                    key={j}
                    className={`absolute w-3 h-3 bg-gradient-to-r ${stat.color} rounded-full opacity-60`}
                    style={{
          ...
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-20">
            <div 
          ...
          <div className="absolute top-1/4 right-0 transform translate-x-20">
            <div 
              className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center shadow-2xl"
              style={{
                transform: `
                  perspective(1000px)
      ...
      {/* 3D FEATURES SECTION */}
      <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-br from-slate-950 via-black to-slate-900">
        {/* Complex 3D Grid Background */}
        <div className="absolute inset-0">
          <div 
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the future of restaurant automation with AI that thinks, learns, and evolves
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl overflow-hidden">
                  ...
                  {/* Floating Icon */}
                  <div 
                    className={`w-20 h-20 bg-gradient-to-br ${feature.color} rounded-3xl flex items-center justify-center mb-8 shadow-2xl`}
                    style={{
                      transform: `
                        translateZ(40px) 
                  ...
                  <button 
                    className={`mt-8 px-6 py-3 bg-gradient-to-r ${feature.color} rounded-2xl text-white font-semibold shadow-xl transition-all duration-300 hover:scale-105`}
                    style={{
                      transform: `translateZ(50px)`,
      ...
      <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-br from-black via-slate-900 to-indigo-950">
        ...
        <div className="absolute inset-0">
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            <div
              key={i}
              className="absolute bg-gradient-to-r from-transparent via-blue-400 to-transparent opacity-20"
              style={{
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Connect with your existing systems effortlessly. One AI, unlimited possibilities.
            </p>
          </div>

          {/* 3D Integration Ecosystem */}
          <div className="relative">
            {/* Central Hub */}
            <div className="flex justify-center mb-16">
              <div 
                className="relative w-48 h-48 bg-gradient-to-br from-blue-500 via-purple-600 to-indigo-700 rounded-full shadow-2xl"
                style={{
                  transform: `
                    perspective(1500px) 
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div 
                    className="w-24 h-24 bg-gradient-to-br from-white to-blue-100 rounded-2xl flex items-center justify-center shadow-xl"
                    style={{
                      transform: `
                        translateZ(30px) 
            ...
            {/* Integration Brands - Orbital Layout */}
            <div className="relative">
              {[
                { 
                  name: 'Square', 
                ...
                return (
                  ...
                  >
                    ...
                    <div 
                      className="absolute bg-gradient-to-r from-transparent via-blue-400 to-transparent opacity-30"
                      style={{
                    ...
                    {/* Brand Card */}
                    <div 
                      className={`w-32 h-32 bg-gradient-to-br ${brand.color} rounded-2xl shadow-2xl flex flex-col items-center justify-center border border-white/20 backdrop-blur-sm cursor-pointer group transition-all duration-500 hover:scale-110`}
                      style={{
                        boxShadow: `
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div 
                  key={i}
                  className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 shadow-xl"
                  style={{
                    transform: `
                      perspective(1000px) 
      ...
      <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-br from-slate-950 via-black to-slate-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {Array.from({ length: 12 }).map((_, i) => (
            <div
              key={i}
              className="absolute text-white/5 text-8xl font-serif select-none pointer-events-none"
              style={{
                left: `${Math.random() * 100}%`,
                top: `${Math.random() * 100}%`,
                transform: `
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover how restaurants transformed their operations with our AI assistant
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 shadow-2xl overflow-hidden">
                  ...
                  {/* Revenue Badge */}
                  <div 
                    className="absolute -top-3 -right-3 bg-gradient-to-r from-green-500 to-emerald-600 px-4 py-2 rounded-2xl shadow-xl"
                    style={{
                      transform: `translateZ(30px) rotateX(${Math.sin(Date.now() / 2500 + i) * 10}deg)`,
                      boxShadow: '0 10px 30px rgba(16, 185, 129, 0.4)'
                    }}
                  >
                    <span className="text-white font-bold text-sm">{testimonial.revenue}</span>
                  </div>

                  {/* Quote */}
                  <div className="mb-8">
                    <div 
                      className="text-6xl text-blue-400/20 mb-4"
                  ...
                  <div className="flex items-center gap-4">
                    {/* 3D Avatar */}
                    <div 
                      className={`w-16 h-16 bg-gradient-to-br ${testimonial.color} rounded-full flex items-center justify-center shadow-xl border-2 border-white/20`}
                      style={{
                        transform: `
                          translateZ(40px) 
                    ...
                    <div style={{ transform: 'translateZ(25px)' }}>
                      ...
                      <p className="text-gray-400 text-sm">{testimonial.restaurant}</p>
                  ...
                  {/* Animated Background */}
                  <div 
                    className={`absolute inset-0 bg-gradient-to-br ${testimonial.color} opacity-5`}
                    style={{
      ...
      {/* 3D CTA SECTION */}
      <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-950 to-black">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p 
              className="text-2xl text-gray-200 max-w-4xl mx-auto mb-12 leading-relaxed"
              style={{
                transform: 'translateZ(30px)',
                textShadow: '0 2px 15px rgba(0, 0, 0, 0.5)'
              }}
            >
              Join thousands of restaurants already using AI to boost revenue, improve customer experience, and streamline operations
            </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-20">
            {/* Primary CTA Button */}
            <button 
              className="group relative px-12 py-6 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 rounded-3xl text-white font-bold text-xl shadow-2xl transition-all duration-500 hover:scale-105 hover:shadow-blue-500/25"
              style={{
                transform: `
                  perspective(1500px) 
                  rotateX(${-mousePosition.y * 5}deg) 
            ...
            >
              {/* Button Content */}
              <div className="flex items-center gap-4">
                <span style={{ transform: 'translateZ(10px)' }}>Start Free Trial</span>
                <ArrowRight 
            ...
            <button 
              className="group relative px-12 py-6 bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-xl border-2 border-white/20 rounded-3xl text-white font-bold text-xl shadow-xl transition-all duration-500 hover:scale-105 hover:bg-white/10"
              style={{
                transform: `
                  perspective(1500px) 
                  rotateX(${-mousePosition.y * 3}deg) 
            ...
            >
              <div className="flex items-center gap-4">
                <Play 
                  ...
                  style={{ transform: 'translateZ(15px)' }}
                />
                <span style={{ transform: 'translateZ(10px)' }}>Watch Demo</span>
              </div>
            </button>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-400 mb-8">Trusted by restaurants worldwide</p>
            <div className="flex items-center justify-center gap-12 opacity-60">
              {['SOC 2', 'GDPR', 'CCPA', 'PCI DSS'].map((cert, i) => (
                <div 
                  key={i}
      ...
      {/* 3D FOOTER */}
      <footer className="relative bg-gradient-to-br from-black via-slate-900 to-indigo-950 py-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div 
                  className="w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl flex items-center justify-center shadow-xl"
                  style={{
                    transform: `
                ...
                <span className="text-2xl font-bold text-white">Heyloo</span>
              </div>
              
              <p className="text-gray-400 leading-relaxed">
                The future of restaurant automation. AI that understands, processes, and delivers exceptional customer experiences.
              </p>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <button 
                    key={i}
                    className={`w-12 h-12 bg-gradient-to-br ${social.color} rounded-xl flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110`}
                    style={{
                      transform: `
                        translateZ(${5 + i * 2}px) 
            ...
            >
              ...
              <ul className="space-y-3 text-gray-400">
                {['Voice AI Assistant', 'POS Integration', 'Analytics Dashboard', 'Multi-language Support'].map((item, i) => (
                  <li 
                    key={i}
            ...
            >
              ...
              <ul className="space-y-3 text-gray-400">
                {['Documentation', 'API Reference', 'Case Studies', 'Support Center'].map((item, i) => (
                  <li 
                    key={i}
                    className="hover:text-white transition-colors cursor-pointer"
                    style={{
          ...
          <div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-gray-400 text-sm">
              © 2024 Heyloo Technologies. All rights reserved.
            </div>
