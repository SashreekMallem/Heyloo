# Build Notes — Archive (Wave 0–4, 2026-09-09/10)

Older entries moved out of `docs/BUILD_NOTES.md` (FINAL-1,
2026-09-21) purely for size — that file was approaching CI's 1MB
tracked-file guard (`repo hygiene` job). Nothing here was edited,
only relocated; content is unchanged from the original entries.
